  ...
  Peer = (function(_super) {
    ...
    Peer.prototype.receive = function(data) {
      if (data.request === "ack") {
        ...
        return this.emit("data", this, data);
      }
    };
    ...
    UDPHoleClient.prototype.initProtocol = function(done) {
      this.socket.on("message", (function(_this) {
        return function(encodedData, publicInfo) {
          ...
          if ((_ref = data.request) !== "connect" && _ref !== "register" && _ref !== "heartbeat" && _ref !== "bye") {
          ...
          if (data.request === "heartbeat") {
            return _this.sendToHost(publicInfo, encodedData);
          }
          if (data.request === "connect") {
            ...
            for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
              ...
              peer.on("data", function(peer, data) {
                return _this.emit("data", peer, data);
              });
            }
          }
          if (data.request === "register" && data.status === 200) {
            return console.log("Registration of service \'" + _this.service.name + "\' successful");
          }
        };
      })(this));
